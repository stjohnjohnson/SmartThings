 ...
 *
 *  History:
 *  2015.11.10: Removed switch code and focused on power instead
 */
metadata {
	definition (name: "Z-Wave Meter", namespace: "stj", author: "stjohnjohnson") {
	...
	// tile definitions
	tiles {
		valueTile("power", "device.power", canChangeIcon: true, width: 2, height: 2) {
			state (
                "default", 
                ...
                backgroundColors:[
                    ...
                    [value: "10 Watts",   color: "#1e9cbb"],
                    [value: "25 Watts",   color: "#90d2a7"],
                    [value: "50 Watts",   color: "#44b621"],
                    [value: "100 Watts",  color: "#f1d801"],
                    [value: "200 Watts",  color: "#d04e00"], 
                    [value: "300 Watts",  color: "#bc2323"] 
                ]
            )
		}
		...
		main(["power","energy"])
		details(["power","energy","refresh","reset"])
	}
}
